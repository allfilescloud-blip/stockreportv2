    ...
    return (
        <div className="p-4 md:p-8 max-w-full mx-auto">
            <div className="mb-8">
                ...
                <p className="text-slate-500 dark:text-slate-400">Resumo geral das operações de estoque</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {cards.map((card, idx) => (
                    <div key={idx} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xl">
                        ...
                        <h2 className="text-3xl font-bold text-slate-900 dark:text-white mt-1">{card.value}</h2>
                    </div>
                ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
                    ...
                    <div className="space-y-4">
                        {recentReports.map(report => (
                            <div key={report.id} className="flex items-center justify-between p-4 bg-slate-100/40 dark:bg-slate-800/40 rounded-xl border border-slate-300/50 dark:border-slate-700/50">
                                ...
                                <div className="text-right">
                                    <p className="text-slate-900 dark:text-white font-bold">{report.totalItems}</p>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
                    <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-6">Status PWA</h2>
                    <div className="space-y-4">
